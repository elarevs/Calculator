...
class MainStackView: UIStackView {
    ...
    private func setupMainStackView() {
        ...
        //можно было через arranged, но так удобнее, тк мы указали сразу axis, spacing, dist.
        ...
        let buttonAC = createButton(title: "AC", tag: 18, color: .gray)
        let buttonPlusMinus = createButton(title: "+/-", tag: 17, color: .gray)
